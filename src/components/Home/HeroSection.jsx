...
const HeroSection = () => {
  return (
    <div className="relative w-full h-[550px] md:h-[650px] lg:h-screen bg-black overflow-hidden"
    >
      ...
      <div className='absolute  left-0 right-0 mx-auto bottom-0 lg:-bottom-[150px]'>
